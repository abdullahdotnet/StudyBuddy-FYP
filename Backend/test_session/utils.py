...
def initialize_chain():
    ...
    global qa_chain
    if qa_chain is None:
        past_paper_folder = "D:\\project\\StudyBuddy-FYP\\Backend\\test_session\\sub_output_pdfs"  # Folder containing past paper PDFs
        past_paper_paths = get_pdf_files_from_folder(past_paper_folder)
    
        subject_book_paths = ["D:\\project\\StudyBuddy-FYP\\Backend\\test_session\\cs9.pdf"]  # Add your subject book PDFs here
