  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between p-11 bg-white h-full">
      ...
      <div className="flex flex-col space-y-3 md:w-1/2 items-center">
        ...
        <button className="flex items-center space-x-2 px-6 py-3  bg-customDarkBlue text-white rounded-full shadow-lg hover:bg-customDarkBlueHover focus:outline-none"
        onClick={navigateToDashboard}
        >
          <span className="font-semibold roboto-font">Get Started</span>
          <img src="src/assets/icons/rightarrow.svg" alt="arrow" className="w-6 h-6 brightness-0 invert" />
        </button>
      </div>
